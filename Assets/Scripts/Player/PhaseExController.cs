...
public class PhaseExController : MonoBehaviour
{
    ...
    float timeCount;
    PhaseEx activePhase;
    private StoryExController ssControl;
    ...
    public void startPhase(PhaseEx fase)
    {
    ...
    void Start()
    {
        ...
        ssControl = FindObjectOfType<StoryExController>();
    }
