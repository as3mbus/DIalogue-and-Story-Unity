...
namespace as3mbus.Story
{
    ...
    public class PhaseEx
    {
        ...
        public PhaseEx(string name, string bundleName, string comicPath)
        {
            this.name = name;
        ...
        public static PhaseEx parseOldJson(JsonData phaseData)
        {
            PhaseEx fase = new PhaseEx();
        ...
        public static PhaseEx parseJson(JsonData phaseData)
        {
            PhaseEx fase = new PhaseEx();
